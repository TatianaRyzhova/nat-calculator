    ...
    <div className="container">
        ...
        <p>У<sub>эер</sub> = -0,278 + 0,085 * Х<sub>лей</sub> + 0,006 * Х<sub>ней</sub> + 0,319 * Х<sub>мон</sub> + 0,001 * Х<sub>лим</sub> + 0,110 * Х<sub>гмк</sub> + 0,001 * Х<sub>трб</sub> + 1,488 * Х<sub>эр</sub> - 0,044 * Х<sub>гем</sub> - 0,093 * Х<sub>об</sub></p>
            ...
            <ul>
                ...
                <li>Х<sub>мон</sub> – уровень моноцитов </li>
                <li>Х<sub>лим</sub> - уровень  лимфоцитов</li>
                <li>Х<sub>гмк</sub> – уровень гематокрита</li>
                <li>Х<sub>трб</sub> – уровень тромбоцитов</li>
                <li>Х<sub>эр</sub> – ровень  эритроцитов</li>
                <li>Х<sub>гем</sub> – уровень гемоглобина</li>
                <li>Х<sub>об</sub> – уровень общего белка</li>
            ...
            <div className="result">
                ...
                <p className="information">{'Уэер > 0,014 - группа высокого риска развития послеродового эндомтерита.'}</p>
                <p className="information">{'Уэер < 0,014 - группа низкого риска развития послеродового эндомтерита.'}</p>
            </div>
    </div>
);
}
